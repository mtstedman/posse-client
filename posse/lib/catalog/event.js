...
export const EVENT_TYPES = Object.freeze({
  ...
  PLANNER_DISPATCH_REJECTED: "planner.dispatch_rejected",
  ...
  GIT_MERGE: "git.merge",
  GIT_MERGE_CANDIDATE_TESTS: "git.merge_candidate_tests",
  ...
  SHARED_TRUNK_PROVENANCE_BLOCKED: "shared_trunk.provenance_blocked",
  SESSION_JOB_OFFERED: "session.job_offered",
  SESSION_JOB_MERGED: "session.job_merged",
  ...
  JOB_ASSESSMENT_DEFERRED_FOR_DIRTY_WORKTREE: "job.assessment_deferred_for_dirty_worktree",
  ...
  JOB_ASSESSMENT_INFRASTRUCTURE_EXHAUSTED: "job.assessment_infrastructure_exhausted",
  ...
  JOB_SCOPE_REQUEST_ABANDONED: "job.scope_request_abandoned",
  ...
  JOB_HEADLESS_GATE_DEPENDENT_CANCELED: "job.headless_gate_dependent_canceled",
  ...
  JOB_ORPHANED_REVIEW_RECOVERY_EXHAUSTED: "job.orphaned_review_recovery_exhausted",
  ...
  PLAN_MODALITY_MISMATCH: "plan.modality_mismatch",
  PLAN_MODALITY_RECOVERY: "plan.modality_recovery",
  PLAN_MODALITY_RECOVERY_EXHAUSTED: "plan.modality_recovery_exhausted",
  ...
  WORK_ITEM_REOPENED: "work_item.reopened",
