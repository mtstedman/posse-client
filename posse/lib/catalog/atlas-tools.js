  ...
  "code.window": {
    ...
    parameters: {
      ...
      properties: {
        ...
        identifiersToFind: { type: "array", items: { type: "string" }, description: "File-mode anchors for bounded slices." },
        expectedLines: { type: "integer", description: "Approximate total lines for file-mode slices." },
