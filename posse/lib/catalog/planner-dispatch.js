...
export const PLANNER_DISPATCH_SETTINGS = Object.freeze([
  { key: SETTING_KEYS.PLANNER_DISPATCH_MODE, default: PLANNER_DISPATCH_MODES.ROUTER, options: PLANNER_DISPATCH_MODE_VALUES, description: "Planner-led intake for every repository on this account. Router preserves current behavior; planner skips upfront research and preflight and lets the planner dispatch bounded code or web research children." },
