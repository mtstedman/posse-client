...
export class AgentDispatcher {
  ...
  describeAgent(agentOrKey) {
    ...
    return Object.freeze({
      ...
      requestedPolicy: this.toolContractFor({
        ...
        agentHandoffReportOnly: preparation.agentHandoffReportOnly === true,
        subAgent: preparation.subAgent === true,
        dispatchAgent: preparation.dispatchAgent === true,
        webResearchHandoff: preparation.webResearchHandoff === true,
        researchInvestigation: preparation.researchInvestigation === true,
  ...
  createAgent({
    ...
    const preparation = {
      ...
      agentHandoffReportOnly: agentHandoffReportOnly === true,
