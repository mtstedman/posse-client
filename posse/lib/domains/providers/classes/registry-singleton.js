...
import * as claude from "../functions/claude.js";
...
try {
  providerRegistry.register("openai", await import("../functions/openai.js"));
} catch (err) {
  providerRegistry.setLoadError("openai", err);
}

try {
  providerRegistry.register("codex", await import("../functions/codex.js"));
} catch (err) {
  providerRegistry.setLoadError("codex", err);
}

try {
  providerRegistry.register("grok", await import("../functions/grok.js"));
} catch (err) {
  providerRegistry.setLoadError("grok", err);
}

try {
  providerRegistry.register("copilot", await import("../functions/copilot.js"));
} catch (err) {
