...
export const SETTINGS_CATALOG = [
  ...
  { key: "atlas_boot_wait_embeddings",    default: "false",              valueType: "boolean", adminVisible: false, description: "Block boot until embedding encode reaches parity. Default off: boot returns once SCIP + views are ready and embeddings keep warming in the background" },
