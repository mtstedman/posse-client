...
export const SETTINGS_CATALOG = [
  ...
  { key: "atlas_search_result_paging", default: "on",             options: ["off", "on"], description: "Bounded-ingress paging for symbol.search results: keep the top of the ranked payload inline (10K char cap) and page the remainder behind fetch_ref. On (default) is a transport invariant — unbounded search was a primary retained-input regression; off is an operator escape hatch." },
