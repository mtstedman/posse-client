...
export const SETTINGS_CATALOG = [
  ...
  { key: "atlas_researcher_typed_dispatcher", default: "off",           options: ["off", "on"], adminVisible: false, description: "Experimental Codex researcher-only typed Atlas dispatcher: preserve parallel direct calls through one closed action/args schema, retain canonical owner routing and validation, retain authorized read_file access under the source gate, and omit git_history, inspect_file, and hash_file while retaining list/search and operator feedback." },
