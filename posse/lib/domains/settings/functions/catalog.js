...
export const SETTINGS_CATALOG = [
  ...
  { key: "atlas_v2_boot_soft_timeout_ms", default: "15000",              numeric: { integer: true, min: 0 }, adminVisible: false, description: "Milliseconds before ATLAS boot warmup reaches its soft-timeout; interactive boots then offer Enter-to-background while continuing to wait, non-interactive boots background automatically; 0 waits for completion" },
