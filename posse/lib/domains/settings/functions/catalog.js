...
export const SETTINGS_CATALOG = [
  ...
  { key: "atlas_result_ref_paging",       default: "on",                 options: ["off", "on"], description: "Window/lens result ref-paging (TOKEN-LEVERS L3b): when a code.window/code.lens result exceeds atlas_result_ref_paging_min_chars, keep the top-ranked portion inline (code.lens: top matches; code.window: head lines) and page the remainder behind a fetch_ref stub. ADOPTED run41 (7C/2P/0W vs 4C/5P/0W for +2.4% cost); flip off to restore full inline results." },
