...
export function buildMcpOAuthClaimsFromBootConfig(bootConfig = {}) {
  ...
  return {
    ...
    capabilities: {
      ...
      agentHandoffReportOnly: bootConfig.agentHandoffReportOnly === true,
      ...
      customTools: bootConfig.customTools === true,
...
export function bootConfigFromMcpOAuthClaims(claims = {}) {
  ...
  return {
    ...
    researchInvestigation: capabilities.researchInvestigation === true,
    agentHandoffReportOnly: capabilities.agentHandoffReportOnly === true,
    ...
    customTools: capabilities.customTools === true,
