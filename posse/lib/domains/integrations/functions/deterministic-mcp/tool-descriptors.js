...
export const TOOL_EXECUTION_SPECS = Object.freeze({
  ...
  "code.window": { access: "atlas", summary: "Bounded exact code for one symbol or file region. Follow returnedFunctionAnchors refs for directly returned anonymous callables. Do not call code.window more than once for the same symbol or substantially overlapping file/identifier selection; follow continuationRef when present." },
