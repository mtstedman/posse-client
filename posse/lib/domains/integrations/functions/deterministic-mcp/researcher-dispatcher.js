...
const TYPED_ACTION_CARDS = Object.freeze({
  ...
  "code.skeleton": "scan one file for declarations and class members, with source ranges, compact symbolRef names for symbol.get (pass name plus the map file), and explicit completeness; fields file or symbolId,identifiersToFind,exportedOnly,limit,maxTokens,surveyGap",
