...
-- -----------------------------------------------------------------------------
-- Native ATLAS memories. Memories are durable repo-scoped knowledge records linked
-- to v2 symbol identities and repo-relative files. This replaces the original
-- ATLAS-MCP memory graph with ledger-owned storage.
-- -----------------------------------------------------------------------------
