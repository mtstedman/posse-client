 ...
 * @returns {string}
 */
function ftsQueryForTerm(term, opts) {
 ...
 */
function runSlice(db, hydrateSymbol, seedGlobalIds, opts) {
 ...
 *   neighborsStmt: Database.Statement,
 * }} args
 ...
 * @returns {ViewSymbol[]}
 */
function runBlastRadius(db, hydrateSymbol, paths) {
  const MAX = 1000;
  const MAX_DEPTH = 8;
  const DECAY = 0.65;
