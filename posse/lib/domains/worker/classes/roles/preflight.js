      ...
      payload.preflight_objective === "oneshot_scope"
        ...
        : payload.preflight_objective === "pipeline_route"
          ? [
            ...
            "Return mode \"solo\" when correctness depends on repository investigation, unclear ownership, cross-cutting implications, or a missing behavioral contract.",
            "Security, concurrency, or data-loss risk alone does not require research when the request already fixes ownership and observable behavior; preserve that risk in the planner/developer strength instead.",
